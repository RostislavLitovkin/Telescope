...
- [ ] T004 [P] Establish CI quality gates (lint, type checks, tests)
...
- [ ] T011 [P] Identify reusable modules/components and map intended reuse
- [ ] T012 [P] Define shared UX patterns (states, copy, interactions)
- [ ] T013 [P] Define responsive breakpoints and testing approach
...
- [ ] T016 [P] [US1] Responsive behavior test for [journey] at mobile and desktop sizes
...
- [ ] T023 [US1] Reuse shared modules/components and document deviations
- [ ] T024 [US1] Validate UX consistency against shared patterns
...
- [ ] T027 [P] [US2] Responsive behavior test for [journey] at mobile and desktop sizes
...
- [ ] T032 [US2] Reuse shared modules/components and document deviations
- [ ] T033 [US2] Validate UX consistency against shared patterns
...
- [ ] T036 [P] [US3] Responsive behavior test for [journey] at mobile and desktop sizes
...
- [ ] T040 [US3] Reuse shared modules/components and document deviations
- [ ] T041 [US3] Validate UX consistency against shared patterns
...
- [ ] TXXX [P] Final responsive verification across supported breakpoints
- [ ] TXXX Constitution compliance evidence review before release
